...
public class Venue extends Room {
    ...
    public String getFullDetail(){
        ...
        total.append(this.nthItem + ". ").append(this.getId()).append(" (").append(totalDesks).append(" desks)");
        total.append("\n");
...
// Read the next non-blank, non-comment string from the reader and return trimmed string
        ...
        String[] bits = heading.split("\\. ", 2); // limit to 2 parts

        int index = CSSE7023.toInt(bits[0], "Number format exception parsing Room " + nthItem + " header");
